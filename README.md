...
***
# Instalable
Es posible crear su propio instalable, para esto debe descargar el repositorio del juego y ejecutarlo en su computador. Son requeridas las librerias Numpy, Math y Pygame. Adicionalmente debe instalar pyinstaller mediante el comando:
 
     pip install pyinstaller

Posteriormente desde la ubicación del juego debe ejecutar el comando:

     pyinstaller --windowed --onefile --icon=./cañon2.ico proyecto.py

Se crearán un conjunto de archivos y carpetas, debe abrir la carpeta dist y mover el único archivo allí presente dentro de la carpeta que aloja el proyecto. Se recomienda emplear una versión de python sin paquetes adicionales instalados debido a que esto incrementará el tamaño del ejecutable creado. El ejecutable siempre debe ser almacenado junto al proyecto debido a que se debe tener acceso a diferentes archivos empleados en el código.
